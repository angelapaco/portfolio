      ...
      <div className="contact">
        <div className="github-wrapper">
          ...
          <a href="https://github.com/angelapaco" target="_blank" className='contact-link' onMouseEnter={playBoop}>
            <img src={import.meta.env.BASE_URL + "src/assets/svg/github-mark.svg"} alt="email svg icon"/>
            <p>angelapaco</p>
          </a>
        </div>
        <div className="email-wrapper">
          ...
          <a href="mailto:janice.paco@gmail.com" className='contact-link' onMouseEnter={playBoop}>
            <img src={import.meta.env.BASE_URL + "src/assets/svg/email.svg"} alt="email svg icon"/>
